...
export class GreatPicture extends GreatItem{
    ...
    constructor(id: number, title: string, height: number, width: number, src:string, extension: extensionType, alt?: string) {
        super(id,title)
        this.alt=alt || '';
        this.width=width;
        this.height=height;
...
const album: GreatAlbum = new GreatAlbum(12,'Gallery', "Gallery 12", 'Good Album');
const photo: GreatPicture = new GreatPicture(312, 'Pic',180,180, './photo-312.png', 'png');
